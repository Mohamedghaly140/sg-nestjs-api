...
Ensures every new or changed endpoint follows this repo's non-negotiable conventions (`CLAUDE.md` rule #8) instead of re-deriving them from memory each time.
